...
export const getGroupsManagerApi = async (
  params: GroupManagerParams,
): Promise<GroupManagerDTO> => {
  const paramsNew = stringify(params, { indices: false })
  const response = await axios.get(`/group?${paramsNew}`)
  return response.data
}

export const postGroupManagerApi = async (
  name: string,
): Promise<GroupManagerDTO> => {
  const data = { name }
...
export const getGroupManagerApi = async (
  id: number,
): Promise<GroupManagerDTO> => {
...
export const changeNameGroupManagerApi = async (
  id: number,
  name: string,
): Promise<GroupManagerDTO> => {
...
export const deleteGroupManagerApi = async (
  id: number,
): Promise<GroupManagerDTO> => {
...
export const postListSetApi = async (
  data: number[],
  params: number,
): Promise<GroupManagerDTO> => {
...
export const getListUserGroupApi = async (
  id: number,
): Promise<UserInGroup[]> => {
...
export const getListSearchGroupApi = async (
  keyword: string,
): Promise<ItemGroupManage[]> => {
  const response = await axios.get(
    `/group/search/share_groups?keyword=${keyword}`,
  )
  return response.data
}
