...
class FileWriter:
    ...
    @classmethod
    def tc(cls, rule_config: Rule):
        info = {rule_config.return_arg: TcData(rule_config.input, rule_config.params)}
        nwbfile = rule_config.nwbfile
        info["nwbfile"] = {"input": nwbfile}
        return info

    @classmethod
    def ts(cls, rule_config: Rule):
        info = {rule_config.return_arg: TsData(rule_config.input, rule_config.params)}
        nwbfile = rule_config.nwbfile
        info["nwbfile"] = {"input": nwbfile}
        return info
