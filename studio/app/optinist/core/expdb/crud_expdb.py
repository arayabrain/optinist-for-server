...
def extract_experiment_view_attributes(attributes: dict) -> dict:
    try:
        ...
        view_attributes = {
            "brain_area": attributes_metadata_attr[SPECIMEN_KEY][
                "Brain region Marmoset"
            ][-1]["label"],
            "imaging_depth": attributes_metadata_attr[MODALITY_IMAGING_KEY][
                "Ca Imaging>Depth"
            ],
            "promoter": attributes_metadata_attr[MODALITY_IMAGING_KEY][
                "Ca Imaging>Promoter"
            ],
            "indicator": attributes_metadata_attr[MODALITY_IMAGING_KEY][
